input_bam=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/ENCODE_ATAC_downloads/GM12878/sorted_merged.bam
...
out_dir=GM12878_ATAC_TOBIAS

#TOBIAS ATACorrect --bam $input_bam --genome $genome --peaks $peaks --blacklist $blacklist --outdir $out_dir --cores 8

corrected=GM12878_ATAC_TOBIAS/sorted_merged_corrected.bw 
uncorrected=GM12878_ATAC_TOBIAS/sorted_merged_uncorrected.bw 
expected=GM12878_ATAC_TOBIAS/sorted_merged_expected.bw 
...
#TOBIAS BINDetect --motifs $motifs --signals $signal --genome $genome --peaks $peaks --peak_header $peaks_header --outdir $out_dir --cond_names GM12878 --cores 8
...
#bound=$outdir/$motif/beds/$motif_GM12878_bound.bed
#unbound=$outdir/$motif/beds/$motif_GM12878_unbound.bed
outdir=$out_dir
...
#TOBIAS PlotAggregate --TFBS $outdir/$motif/beds/$motif"_all.bed" $outdir/$motif/beds/$motif"_GM12878_bound.bed" $outdir/$motif/beds/$motif"_GM12878_unbound.bed" --signals $uncorrected $bias $corrected $orig --output $outdir/plots/tobias_$motifname"_footprint.png" --share_y sites --plot_boundaries
