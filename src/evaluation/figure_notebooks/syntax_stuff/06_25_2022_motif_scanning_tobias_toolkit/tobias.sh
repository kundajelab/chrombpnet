input_bam=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/ENCODE_ATAC_downloads/HEPG2/sorted_merged.bam
...
expected=HEPG2_ATAC_TOBIAS/sorted_merged_expected.bw 
...
#TOBIAS BINDetect --motifs $motifs --signals $signal --genome $genome --peaks $peaks --peak_header $peaks_header --outdir $out_dir --cond_names HEPG2 --cores 8
