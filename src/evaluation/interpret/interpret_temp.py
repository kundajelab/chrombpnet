...
def main(args):
    ...
    genome = pyfaidx.Fasta(args.genome, mutable=True)
    orig = genome["chr6"][14501674:14501675]

    genome["chr6"][14501368:14501369] = "G"
#    genome["chr6"][14501674:14501675] = "T"



    seqs, peaks_used = context.get_seq(regions_df, genome, inputlen)

    genome["chr6"][14501368:14501369] = "A"
#    genome["chr6"][14501674:14501675] = "G"
    genome.close()
