...
def main():
    ...
    for motif in  scores.keys():
        ...
        scores_text = get_footprint_characteristics(width, motif_footprint, control_fotprint, args.title, args.output_prefix, motif)
    ...
    #df.to_csv(args.output_prefix+"_all_scores.csv", index=False)
