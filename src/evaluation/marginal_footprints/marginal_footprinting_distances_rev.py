...
for i,r in motif_table.iterrows():
	...
	motif=r['motif2_strings_corrected'][::-1]
	batch_size=128
	motif2_footprint = get_footprint_for_motif(regions_seqs, motif, model, inputlen, batch_size)

	motifs = [r['motif1_strings_corrected'], r['motif2_strings_corrected'][::-1]]
...
save_to_h5('composite_footprint_data_rev.h5', store_data_object)
