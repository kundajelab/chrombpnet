...
# warning about skipping edge cases
# warning about meta-data
# warning about dubplicates
# warnign about snps only
# warnign about input length
...
if __name__=="__main__":
    ...
    pkl.dump(data, open(os.path.join(args.output_dir+"predictions_at_snp.h5"),'wb'))
