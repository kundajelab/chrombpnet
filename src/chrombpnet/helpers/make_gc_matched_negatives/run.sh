...
echo $( timestamp ): "python $PWD/helpers/make_gc_matched_negatives/get_gc_content.py \\
...
python $PWD/helpers/make_gc_matched_negatives/get_gc_content.py \
        --input_bed $foreground_bed \
        --genome $genome \
        --chrom_sizes $chrom_sizes \
        --output_prefix $output_dir/foreground.gc \
...
echo $( timestamp ): "python $PWD/helpers/make_gc_matched_negatives/get_gc_matched_negatives.py \\
...
python $PWD/helpers/make_gc_matched_negatives/get_gc_matched_negatives.py \
        --candidate_negatives $output_dir/candidate.negatives.bed \
        --foreground_gc_bed $output_dir/foreground.gc.bed \
        --output_prefix $output_dir/negatives \
        --chr_fold_path $fold \
