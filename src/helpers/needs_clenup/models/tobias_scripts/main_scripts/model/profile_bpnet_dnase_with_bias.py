...
def getModelGivenModelOptionsAndWeightInits(args):
    ...
    concat_with_bias_prof=Concatenate(axis=-1)([profile_out_prebias,bias_profile_input])
    ...
    concat_with_bias_count=Concatenate(axis=-1)([gap_combined_conv,bias_counts_input])
    count_out = Dense(num_tasks, name="logcount_predictions")(concat_with_bias_count)
    model=Model(inputs=[inp, bias_profile_input, bias_counts_input],outputs=[profile_out,
                                     count_out])
    print("got model") 
