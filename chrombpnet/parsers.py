...
def read_parser():
        ...
        def general_training_args(required_train, optional_train):
                ...
                optional_train.add_argument("-cw", "--chunk_write",action='store_true',default=False, help="writing shap to h5 file in chunk")
       ...
       # bias model qc arguments
        ...
        optional_contribs.add_argument("-bs", "--batch-size", type=int, default=128, help="batch size to use for model training")
