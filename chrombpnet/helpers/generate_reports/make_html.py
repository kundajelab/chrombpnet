...
def main(args):
	...
	page_title_text='Bias factorized ChromBPNet training quality check report'
	...
	data = open(os.path.join(prefix,"evaluation/chrombpnet_nobias_max_bias_resonse.txt")).read()
	vals = data.split("_")
