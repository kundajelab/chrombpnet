...
CUDA_VISIBLE_DEVICES=0 kerasAC_bpnet_shap_wrapper \
		    --model_hdf5 /srv/scratch/annashch/deeplearning/profile/gm12878_atac/baseline/gm12878.atac.seed.1234.cs.55.filters.500.naive.range.4.6.to.11.5.$fold.hdf5 \
		    ...
		    --out_pickle GM12878.ATAC.baseline.fold$fold.deepSHAP \
		    --num_threads 10
