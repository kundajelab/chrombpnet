#!/bin/bash
outdir=/srv/scratch/annashch/deeplearning/profile/gm12878_atac/with_bias_unplugged
model=gm12878.atac.with.bias.unplugged
seed=1234
gpu=1

for fold in 0 1 2 3 4
do
    title="gm12878 atac bias unplugged fold $fold"
