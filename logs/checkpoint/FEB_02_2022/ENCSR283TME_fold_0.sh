...
setting=DNASE_SE_02.01.2022
cur_file_name="ENCSR283TME_fold_0.sh"
### SIGNAL INPUT
...
neg_data=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/negatives_data/negatives_with_summit.bed
