...
cur_file_name="hepg2_dnase_fold_0.sh"
setting=DNASE_SE_01.24.2022_0.9
### SIGNAL INPUT

in_bam=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/DNASE/unfiltered_bams/HEPG2/HEPG2.unfiltered.sorted.bam
