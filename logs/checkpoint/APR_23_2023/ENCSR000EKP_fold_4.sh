...
foldnum=4
setting=$data_type"_"$date"_fold_"$foldnum"_"$bias_threshold_factor
cur_file_name="ENCSR000EKP_fold_"$foldnum".sh"
gpu=2

### SIGNAL INPUT


in_bam=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR000EKP/preprocessing/bigWigs/sorted_ENCSR000EKP.bam
bigwig=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR000EKP/preprocessing/bigWigs/ENCSR000EKP.bigWig
overlap_peak=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR000EKP/preprocessing/downloads/peaks.bed.gz
chrom_sizes=/mnt/data/annotations/by_release/hg38/hg38.chrom.sizes
ref_fasta=/mnt/data/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta
fold=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/ENCODE_ATAC_downloads/splits/fold_$foldnum".json"
...
genomewide_gc=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/reference/genomewide_gc_hg38_stride_1000_inputlen_2114.bed
...
neg_dir=$main_dir/negatives_data_$foldnum
...
if [[ -d $output_dir/bias_model ]] ; then
    ...
    CUDA_VISIBLE_DEVICES=$gpu bash step4_train_bias_model.sh $ref_fasta $bigwig $overlap_peak $neg_dir/negatives_with_summit.bed $fold $bias_threshold_factor $output_dir/bias_model $bias_filters $bias_dil $seed
fi
