...
setting=$data_type"_"$date"_"$bias_threshold_factor"_fold_1"
cur_file_name="ENCSR000EJR_fold_1.sh"
setting=DNASE_SE_03.16.2023_1.0_fold_1
### SIGNAL INPUT
