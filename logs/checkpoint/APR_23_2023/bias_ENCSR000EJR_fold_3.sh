...
setting=$data_type"_"$date"_"$bias_threshold_factor"_fold_3"
cur_file_name="ENCSR000EJR_fold_3.sh"
setting=DNASE_SE_03.16.2023_1.0_fold_3
### SIGNAL INPUT


in_bam=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR000EJR/preprocessing/bigWigs/sorted_ENCSR000EJR.bam
bigwig=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR000EJR/preprocessing/bigWigs/ENCSR000EJR.bigWig
...
neg_dir=$main_dir/negatives_data_3
