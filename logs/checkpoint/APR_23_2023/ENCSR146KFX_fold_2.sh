...
setting=$data_type"_"$date"_fold_2_"$bias_threshold_factor
cur_file_name="ENCSR146KFX_fold_2.sh"
### SIGNAL INPUT
...
neg_dir=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR146KFX/negatives_data_2/
if [[ -d $neg_dir ]] ; then
...
neg_data=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR146KFX/negatives_data_2/negatives_with_summit.bed
