...
setting=$data_type"_"$date"_fold_4_"$bias_threshold_factor
cur_file_name="ENCSR146KFX_fold_4.sh"
### SIGNAL INPUT
...
neg_dir=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR146KFX/negatives_data_4/
if [[ -d $neg_dir ]] ; then
...
neg_data=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR146KFX/negatives_data_4/negatives_with_summit.bed
