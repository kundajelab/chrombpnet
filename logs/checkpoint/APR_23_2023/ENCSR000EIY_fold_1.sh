...
cell_line=ENCSR000EIY
data_type="DNASE_SE"

date=$(date +'%m.%d.%Y')
setting=$data_type"_"$date"_with_encsr000ekp_model"
cur_file_name="ENCSR000EIY_fold_0.sh"
setting="DNASE_SE_02.28.2023_with_encsr000ekp_model"

### SIGNAL INPUT

in_bigwig=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR000EIY/preprocessing/bigWigs/ENCSR000EIY.bigWig
overlap_peak=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR000EIY/preprocessing/downloads/peaks.bed.gz
...
neg_dir=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR000EIY/negatives_data/
