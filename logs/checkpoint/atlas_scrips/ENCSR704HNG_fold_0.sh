...
cell_line=ENCSR704HNG
data_type="DNASE_SE"

date=$(date +'%m.%d.%Y')
bias_threshold_factor=0.9
setting=$data_type"_"$date"_"$bias_threshold_factor
cur_file_name="ENCSR704HNG_fold_0.sh"
### SIGNAL INPUT

in_bigwig=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR704HNG/preprocessing/bigWigs/ENCSR704HNG.bigWig
overlap_peak=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR704HNG/preprocessing/downloads/peaks.bed.gz
...
neg_data=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR704HNG/negatives_data/negatives_with_summit.bed
...
if [[ -d $output_dir/bias_model/interpret ]] ; then
    ...
    echo $( timestamp ):"python $PWD/src/evaluation/interpret/interpret.py \
        --genome=$ref_fasta \
        --regions=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR704HNG//chrombpnet_model_hepg2_bias/interpret/ranked_ENCSR704HNG.interpreted_regions.bed \
