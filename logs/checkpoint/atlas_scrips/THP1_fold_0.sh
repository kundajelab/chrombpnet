...
cur_file_name="THP1_fold_0.sh"
setting=ATAC_PE_03.24.2022_withgm12878bias
### SIGNAL INPUT


in_bam=/oak/stanford/groups/akundaje/anusri/THP1-Engreitz/sorted_merged.bam
overlap_peak=/oak/stanford/groups/akundaje/anusri/THP1-Engreitz/macs2_peaks.narrowPeak.sorted
...
main_dir=/oak/stanford/groups/akundaje/anusri/THP1-Engreitz/results/chrombpnet/$data_type/

output_dir=$main_dir/$setting
data_dir=$main_dir/data

blacklist_region=/mnt/data/annotations/blacklist/hg19/ENCFF001TDO.bed
genomewide_gc=/oak/stanford/groups/akundaje/anusri/refs/genomewide_gc_hg19_stride_1000_inputlen_2114.bed
