...
#zcat $overlap_peak > $output_dir/peaks_slop1057.bed
...
bash $PWD/src/helpers/make_gc_matched_negatives/run_neg_to_pos_to_1.sh $overlap_peak $exclude_bed $inputlen $output_dir $reference_fasta $genomewide_gc $fold $chrom_sizes $logfile
