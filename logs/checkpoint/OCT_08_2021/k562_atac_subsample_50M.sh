...
date=$(date +'%m.%d.%Y')
setting=4_$neg_shift"_shifted_"$data_type"_"$date"_bias_filters_"$filters"subsample_50M"
cur_file_name="k562_atac_subsample_50M.sh"
setting=4_4_shifted_ATAC_10.05.2021_bias_filters_500subsample_50M
