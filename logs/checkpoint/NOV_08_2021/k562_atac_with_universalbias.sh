...
date=$(date +'%m.%d.%Y')
setting=$data_type"_"$date"_withuniversalbias_500filt"
cur_file_name="k562_atac_with_universalbias.sh"
#setting=ATAC_10.08.2021_withuniversalbias
### SIGNAL INPUT
setting=ATAC_10.14.2021_withuniversalbias_500filt
...
bias_json="/mnt/lab_data3/anusri/chrombpnet_paper/results/chrombpnet/ATAC/UNIVERSAL/4_4_shifted_ATAC_10.14.2021_bias_filters_500/invivo_bias_model_step1/model.0.arch"
bias_weights="/mnt/lab_data3/anusri/chrombpnet_paper/results/chrombpnet/ATAC/UNIVERSAL/4_4_shifted_ATAC_10.14.2021_bias_filters_500/invivo_bias_model_step1/model.0.weights"
