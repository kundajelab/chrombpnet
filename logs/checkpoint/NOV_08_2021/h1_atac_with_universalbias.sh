...
cur_file_name="h1_atac_with_universalbias.sh"
setting=ATAC_10.09.2021_withuniversalbias
...
if [[ -d $output_dir/universal_bias_fit_on_signal_step2 ]] ; then
    ...
    counts_loss_weight_step2=`head -n 1 $output_dir/universal_bias_fit_on_signal_step2/inpeaks_counts_loss_weight.txt`
