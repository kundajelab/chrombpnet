...
cur_file_name="gm12878_atac_with_universalbias.sh"
setting=ATAC_10.08.2021_withuniversalbias
...
if [[ -d $output_dir/universal_bias_fit_on_signal_step2 ]] ; then
    ...
    do
        ...
        bash $PWD/src/models/chrombpnet_scripts/bias_fit_on_signal_step2/train.sh $fold $gpu $model_name $seed $output_dir/universal_bias_fit_on_signal_step2 $params  $data_dir/tiledb/db $cell_line $PWD/src/models/chrombpnet_scripts/bias_fit_on_signal_step2/signal_from_bias.py $neg_bed_train $min_logcount $max_logcount
...
CUDA_VISIBLE_DEVICES=$gpu python  $PWD/src/evaluation/marginal_footrprints/main_footprints_check.py --ref_fasta $ref_fasta --gc_neg $neg_bed_test --motifs gm12878_motifs_set1 --model_dir $output_dir/with_universal_bias_final_model/unplug/
CUDA_VISIBLE_DEVICES=$gpu python  $PWD/src/evaluation/marginal_footrprints/main_footprints_check.py --ref_fasta $ref_fasta --gc_neg $neg_bed_test --motifs gm12878_motifs_set2 --model_dir $output_dir/with_universal_bias_final_model/unplug/
