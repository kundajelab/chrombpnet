...
date=$(date +'%m.%d.%Y')
setting=$data_type"_"$date"_withuniversalbias_retrain"
cur_file_name="gm12878_atac_with_universalbias_retrain.sh"
setting=ATAC_10.11.2021_withuniversalbias_retrain
