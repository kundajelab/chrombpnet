...
cur_file_name="hepg2_dnase_script.sh"

### SIGNAL INPUT

in_bam=/oak/stanford/groups/akundaje/projects/atlas/dnase_processed/dnase/ce805260-55f8-43c8-b2a1-a232b4a0e369/call-bowtie2/shard-0/execution/ENCSR149XIL.merged.bam
overlap_peak=/oak/stanford/groups/akundaje/projects/atlas/dnase_processed/dnase/ce805260-55f8-43c8-b2a1-a232b4a0e369/call-reproducibility_overlap/execution/optimal_peak.narrowPeak
#.gz file?
idr_peak=/oak/stanford/groups/akundaje/projects/atlas/dnase_processed/dnase/ce805260-55f8-43c8-b2a1-a232b4a0e369/call-reproducibility_idr/execution/optimal_peak.narrowPeak.gz
is_filtered=False
samtools_flag=780
...
then
    if [[ -d $output_dir/invivo_bias_model_step1/deepshap ]] ; then
        ...
        for fold in 0
        do
            ./main_scripts/interpret/interpret_weight.sh $output_dir/invivo_bias_model_step1/$model_name.$fold $bed_file xaa $data_dir/tiledb/db $chrom_sizes $output_dir/invivo_bias_model_ste$
            ./main_scripts/interpret/interpret_weight.sh $output_dir/invivo_bias_model_step1/$model_name.$fold $bed_file xab $data_dir/tiledb/db $chrom_sizes $output_dir/invivo_bias_model_ste$
            ./main_scripts/interpret/interpret_weight.sh $output_dir/invivo_bias_model_step1/$model_name.$fold $bed_file xac $data_dir/tiledb/db $chrom_sizes $output_dir/invivo_bias_model_ste$
        done
