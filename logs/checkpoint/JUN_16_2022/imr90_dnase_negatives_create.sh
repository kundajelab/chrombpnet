...
date=$(date +'%m.%d.%Y')
cur_file_name="imr90_dnase_negatives_create.sh"
### SIGNAL INPUT

in_bam=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/DNASE/unfiltered_bams/IMR90/IMR90.unfiltered.sorted.bam
overlap_peak=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/DNASE/optimal_overlap_peaks/IMR90.overlap.optimal_peak.narrowPeak.gz
