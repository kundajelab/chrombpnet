...
echo $( timestamp ): "python $PWD/src/training/train.py \\
       ...
       --seed=$seed \\
       --batch_size=64 \\
       --architecture_from_file=$PWD/src/training/models/bpnet_model_only_profile.py \\
...
python $PWD/src/training/train.py \
       ...
       --batch_size=64 \
       --architecture_from_file=$PWD/src/training/models/bpnet_model_only_profile.py \
       --trackables loss logits_profile_predictions_loss  val_loss val_logits_profile_predictions_loss  | tee -a $logfile
