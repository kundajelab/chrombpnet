...
echo $( timestamp ): "python $PWD/src/helpers/hyperparameters/find_chrombpnet_hyperparams_only_profile.py \\
...
python $PWD/src/helpers/hyperparameters/find_chrombpnet_hyperparams_only_profile.py \
       --genome=$reference_fasta \
       --bigwig=$bigwig_path \
       --peaks=$overlap_peak \
       --nonpeaks=$nonpeaks \
...
echo $( timestamp ): "python $PWD/src/training/train.py \\
       ...
       --seed=$seed \\
       --batch_size=64 \\
       --architecture_from_file=$PWD/src/training/models/chrombpnet_with_bias_profile_model.py \\
