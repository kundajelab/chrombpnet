...
cur_file_name="gm12878_withnakedbias_dnase_fold_0.sh"
setting=DNASE_SE_05.13.2022_withnakedbias
### SIGNAL INPUT
...
transfer_bias_model=$PWD/results/chrombpnet/DNASE_SE/NAKED/bias_model_05.10.2022/bias_model/hint_atac.h5
