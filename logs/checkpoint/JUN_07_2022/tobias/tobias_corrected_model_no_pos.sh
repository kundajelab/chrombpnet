...
echo $( timestamp ): "python $PWD/src/training/tobias_train.py \\
       --genome=$reference_fasta \\
       --bigwig=$bigwig_path \\
...
python $PWD/src/training/tobias_train.py \
       --genome=$reference_fasta \
       --bigwig=$bigwig_path \
       --bias_bigwig=$bias_bigwig \
       --peaks=$output_dir/filtered.peaks.bed  \
...
echo $( timestamp ): "python $PWD/src/training/predict.py \\
        ...
        --output_prefix=$output_dir/tobias \\
        --batch_size=256 \\
        --model_h5=$output_dir/tobias.h5" | tee -a $logfile
