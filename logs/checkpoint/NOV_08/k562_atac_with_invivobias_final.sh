...
date=$(date +'%m.%d.%Y')
setting=$data_type"_"$date"_withinvivobias_biasfilts_"$bias_filters
cur_file_name="k562_atac_with_invivobias_final.sh"
#setting=ATAC_10.09.2021_withinvivobias
#setting=ATAC_10.14.2021_withinvivobias
#setting=ATAC_10.14.2021_withinvivobias
#setting=ATAC_10.18.2021_withinvivobias_biasfilts_256
setting=ATAC_10.18.2021_withinvivobias_biasfilts_128
