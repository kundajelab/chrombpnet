...
date=$(date +'%m.%d.%Y')
setting=$data_type"_"$date"_withk562bias"
cur_file_name="h1_atac_withk562invivobias.sh"

### SIGNAL INPUT
n_bam=/oak/stanford/groups/akundaje/projects/atlas/atac/caper_out/merged_data/H1.atac.filt.merged.bam
