...
date=$(date +'%m.%d.%Y')
setting=$data_type"_"$date"_withk562invivobias"
cur_file_name="gm12878_atac_withk562invivobias.sh"
setting=ATAC_10.27.2021_withk562invivobias
...
bias_json="/srv/scratch/anusri/chrombpnet_paper/results/chrombpnet/ATAC/K562/4_4_shifted_ATAC_09.29.2021_bias_filters_500/invivo_bias_model_step1/model.0.arch"
bias_weights="/srv/scratch/anusri/chrombpnet_paper/results/chrombpnet/ATAC/K562/4_4_shifted_ATAC_09.29.2021_bias_filters_500/invivo_bias_model_step1/model.0.weights"
...
if [[ -d $output_dir/k562_bias_fit_on_signal_step2 ]] ; then
    ...
    counts_loss_weight_step2=`head -n 1 $output_dir/k562_bias_fit_on_signal_step2/innegs_counts_loss_weight.txt`
...
CUDA_VISIBLE_DEVICES=$gpu python  $PWD/src/evaluation/marginal_footrprints/main_footprints_check.py --ref_fasta $ref_fasta --gc_neg $neg_bed_test --motifs gm12878_motifs_set1 --model_dir $output_dir/with_k562_bias_final_model/unplug/
CUDA_VISIBLE_DEVICES=$gpu python  $PWD/src/evaluation/marginal_footrprints/main_footprints_check.py --ref_fasta $ref_fasta --gc_neg $neg_bed_test --motifs gm12878_motifs_set2 --model_dir $output_dir/with_k562_bias_final_model/unplug/
