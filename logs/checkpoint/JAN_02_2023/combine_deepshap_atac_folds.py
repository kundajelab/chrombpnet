...
def filter_regions_to_peaks(bed_of_interest, merged, scores):
	...
	output_prefix="/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/chrombpnet/folds/"+ddtpe+"/"+cell_type+"/merge_folds_all_regions_may_05_24/in_peaks"
...
for cell_type in cell_types:
	...
	for i,r in ndata.iterrows():
		...
		beds_path = os.path.join(r[2],"chrombpnet_model/interpret_all/full_"+cell_type+".interpreted_regions_"+itype+".bed")
		if os.path.exists(beds_path):
			beds = pd.read_csv(beds_path, sep="\t", header=None, compression="gzip")
		elif os.path.exists(os.path.join(r[2],"chrombpnet_model/interpret_all/merged."+cell_type+".interpreted_regions.bed")):
			beds_path = os.path.join(r[2],"chrombpnet_model/interpret_all/merged."+cell_type+".interpreted_regions.bed")
			beds = pd.read_csv(beds_path, sep="\t", header=None, )
		else:
			beds_path = os.path.join(r[2],"interpret_all/merged."+cell_type+".interpreted_regions.bed")
			beds = pd.read_csv(beds_path, sep="\t", header=None)
		...
		elif os.path.exists(os.path.join(r[2],"interpret_all/merged."+cell_type+"."+itype+"_scores_new_compressed.h5")):
	...
	os.makedirs("/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/chrombpnet/folds/"+ddtpe+"/"+cell_type+"/merge_folds_all_regions_may_05_24/", exist_ok=True)
	output_prefix="/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/chrombpnet/folds/"+ddtpe+"/"+cell_type+"/merge_folds_all_regions_may_05_24/"+cell_type+"_folds_merged"
	dd.io.save(output_prefix+"."+itype+"_scores_new_compressed.h5",
						profile_scores_dict,
						compression='blosc')
	output_prefix_bed="/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/chrombpnet/folds/"+ddtpe+"/"+cell_type+"/merge_folds_all_regions_may_05_24/"+cell_type+"_folds_merged"						
