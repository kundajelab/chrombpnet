...
setting=$data_type"_"$date"_"$bias_threshold_factor"_fold_2"
cur_file_name="ENCSR283TME_fold_2.sh"
### SIGNAL INPUT
...
neg_dir=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/negatives_data_2/
if [[ -d $neg_dir ]] ; then
...
neg_data=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/negatives_data_2/negatives_with_summit.bed
