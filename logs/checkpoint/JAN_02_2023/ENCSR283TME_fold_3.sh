...
cell_line=ENCSR283TME
data_type="DNASE_SE"

date=$(date +'%m.%d.%Y')
bias_threshold_factor=0.9
setting=$data_type"_"$date"_"$bias_threshold_factor"_fold_3"
cur_file_name="ENCSR283TME_fold_3.sh"
### SIGNAL INPUT

in_bigwig=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/preprocessing/bigWigs/ENCSR283TME.bigWig
overlap_peak=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/preprocessing/downloads/peaks.bed.gz
...
neg_dir=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/negatives_data_3/
if [[ -d $neg_dir ]] ; then
...
neg_data=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/negatives_data_3/negatives_with_summit.bed
...
if [[ -d $output_dir/bias_model/interpret ]] ; then
    ...
    echo $( timestamp ):"python $PWD/src/evaluation/interpret/interpret.py \
        --genome=$ref_fasta \
        --regions=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME//chrombpnet_model_hepg2_bias/interpret/ranked_ENCSR283TME.interpreted_regions.bed \
