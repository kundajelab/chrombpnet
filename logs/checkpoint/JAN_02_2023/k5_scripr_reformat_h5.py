...
for cell_type in cell_types:
	...
	for i,r in ndata.iterrows():
		...
		itype="counts"
		output_prefix=os.path.join(r[2],"interpret/merged."+cell_type+"."+itype+"_scores_new_compressed.h5")
		output_prefix_bed=os.path.join(r[2],"interpret/merged."+cell_type+".interpreted_regions.bed")
		if not os.path.isfile(output_prefix_bed):
			output_prefix_bed=os.path.join(r[2],"chrombpnet_model/interpret/full_"+cell_type+".interpreted_regions_"+itype+".bed")
			output_prefix=os.path.join(r[2],"chrombpnet_model/interpret/full_"+cell_type+"."+itype+"_scores_new_compressed.h5")
