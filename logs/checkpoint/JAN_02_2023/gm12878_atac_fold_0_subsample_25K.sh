...
date=$(date +'%m.%d.%Y')
cur_file_name="gm12878_atac_fold_0_subsample_25K.sh"

### SIGNAL INPUT

main_dir=/mnt/lab_data3/anusri/chrombpnet/results/chrombpnet/$data_type/$cell_line
in_bam=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/subsampled_ATAC_GM12878/GM12878.filtered.merged.25000000.bam
overlap_peak=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/subsampled_ATAC_GM12878/croo/25m/peak/overlap_reproducibility/overlap.optimal_peak.narrowPeak.gz
data_dir=$main_dir/data_25M
