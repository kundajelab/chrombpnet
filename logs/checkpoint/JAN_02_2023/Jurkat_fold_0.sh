...
cur_file_name="Jurkat_fold_0.sh"
### SIGNAL INPUT


in_bam=/oak/stanford/groups/akundaje/anusri/Jurkat-Engreitz/sorted_merged.bam
overlap_peak=/oak/stanford/groups/akundaje/anusri/Jurkat-Engreitz/macs2_peaks.narrowPeak.sorted
...
main_dir=/oak/stanford/groups/akundaje/anusri/Jurkat-Engreitz/results/chrombpnet/$data_type/
