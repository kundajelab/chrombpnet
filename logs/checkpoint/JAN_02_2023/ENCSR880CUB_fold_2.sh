...
cur_file_name="ENCSR880CUB_fold_2.sh"
...
neg_dir=$PWD/"results/chrombpnet/DNASE_SE/ENCSR880CUB/data/negatives_data_2/"
if [[ -d $neg_dir ]] ; then
...
neg_data=$PWD/"results/chrombpnet/DNASE_SE/ENCSR880CUB/data/negatives_data_2/negatives_with_summit.bed"
