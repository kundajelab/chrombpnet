...
cur_file_name="MemoryCD4_fold_0.sh"
### SIGNAL INPUT


in_bam=/oak/stanford/groups/akundaje/anusri/Mineto-data/MemoryCD4/data/1001_Memory_Teffs-U_R1.trim.merged.srt.nodup.no_chrM_MT.bam
overlap_peak=/oak/stanford/groups/akundaje/anusri/Mineto-data/MemoryCD4/data/overlap.optimal_peak.narrowPeak.gz
...
main_dir=/oak/stanford/groups/akundaje/anusri/Mineto-data/MemoryCD4/
