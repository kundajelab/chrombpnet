...
file1= "results/chrombpnet/ATAC_PE/GM12878/nautilus_runs/GM12878_03.01.2022_bias_128_4_1234_0.4_fold_0/chrombpnet_model/chrombpnet_predictions.h5"
bigwig="results/chrombpnet/ATAC_PE/GM12878/data/GM12878_unstranded.bw"
rep1=pyBigWig.open("results/chrombpnet/ATAC_PE/GM12878/data/replicates/pr1_unstranded.bw")
rep2=pyBigWig.open("results/chrombpnet/ATAC_PE/GM12878/data/replicates/pr2_unstranded.bw")
data = h5py.File(file1)

import pandas as pd

peaks="results/chrombpnet/ATAC_PE/GM12878/nautilus_runs/GM12878_03.01.2022_bias_128_4_1234_0.4_fold_0/chrombpnet_model/filtered.peaks.bed"
...
plt.title("JSD Dist: ")
plt.legend(loc='best')
plt.savefig("results/chrombpnet/ATAC_PE/GM12878/nautilus_runs/GM12878_03.01.2022_bias_128_4_1234_0.4_fold_0/chrombpnet_model/gm12878.no.smooth.jsd.png",format='png',dpi=300)
