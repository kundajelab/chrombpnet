...
cur_file_name="AAVS1_fold_0.sh"
### SIGNAL INPUT


in_bam=/oak/stanford/groups/akundaje/anusri/Mineto-data/AAVS1/data/Donor_1_AAVS1_1_C3_R1_trimmed.trim.merged.srt.nodup.no_chrM_MT.bam
overlap_peak=/oak/stanford/groups/akundaje/anusri/Mineto-data/AAVS1/data/overlap.optimal_peak.narrowPeak.gz
...
main_dir=/oak/stanford/groups/akundaje/anusri/Mineto-data/AAVS1/
