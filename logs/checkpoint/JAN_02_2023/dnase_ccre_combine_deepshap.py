...
for cell_type in cell_types:
	...
	for i,r in ndata.iterrows():
		...
		if os.path.exists(beds_path):
			...
			beds_path = os.path.join(r[2],"interpret_ccre/merged."+cell_type+".interpreted_regions.bed")
			beds2 = pd.read_csv(beds_path, sep="\t", header=None)
		...
		if os.path.exists(ppath):
			...
			ppath = os.path.join(r[2],"chrombpnet_model/interpret_ccre/full_"+cell_type+"."+itype+"_scores.h5")
			scores2 = dd.io.load(ppath)
		...
		os.makedirs(os.path.join(r[2],"chrombpnet_model/interpret_all_with_ccre/"), exist_ok=True)
		print(os.path.join(r[2],"chrombpnet_model/interpret_all_with_ccre/"))
		output_prefix=os.path.join(r[2],"chrombpnet_model/interpret_all_with_ccre/full_"+cell_type+"."+itype+"_scores_new_compressed.h5")
		dd.io.save(output_prefix,
			counts_scores_dict,
			compression='blosc')

		output_prefix_bed=os.path.join(r[2],"chrombpnet_model/interpret_all_with_ccre/full_"+cell_type+".interpreted_regions_"+itype+".bed")
