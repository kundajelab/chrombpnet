...
cur_file_name="ENCSR283TME_fold_1.sh"
### SIGNAL INPUT
...
neg_dir=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/negatives_data_1/
if [[ -d $neg_dir ]] ; then
...
neg_data=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/ENCSR283TME/negatives_data_1/negatives_with_summit.bed
