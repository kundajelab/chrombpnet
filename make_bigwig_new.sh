...
CUDA_VISIBLE_DEVICES=$gpu python src/evaluation/interpret/interpret.py -g $ref_fasta -r $file.interpreted_regions.bed -m $chrombpnet_nb -o $file --profile_or_counts profile
