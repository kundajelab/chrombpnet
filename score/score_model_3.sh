...
#IMR90
CUDA_VISIBLE_DEVICES=3 python score_model.py --model_path /oak/stanford/groups/akundaje/projects/atlas/dnase_processed/dnase/c9ef8473-1374-41ef-9fab-8f07288e94e7/call-bowtie2/shard-0/execution/ENCSR000EMU.merged.bam.bpnet.unstranded.bw \
