...
dsqtl=/mnt/lab_data2/anusri/variant-scorer/src/output/kaur_caqtls_lcl_latest/enformer_preds_small_window/splitss/splitad
genome=/mnt/lab_data2/anusri/chrombpnet/reference/hg38.genome.fa
output_dirn=/mnt/lab_data2/anusri/variant-scorer/src/output/kaur_caqtls_lcl_latest/enformer_preds_small_window/splitss/splitad
mkdir $output_dirn
