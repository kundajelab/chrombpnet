...
date=$(date +'%m.%d.%Y')
setting=4_$neg_shift"_shifted_"$data_type"_"$date"_subsample_500M"
cur_file_name="withgm12878bias_k562_atac_subsample_500M.sh"
setting=4_4_shifted_ATAC_09.16.2021_subsample_500M
### SIGNAL INPUT
