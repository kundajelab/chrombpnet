...
output_dirn=$model_dir/dsqtls_interpret_small_ld_indi/
mkdir $output_dirn
gpu=3
...
#output_dirn=results/chrombpnet/DNASE_SE/GM12878/nautilus_runs/over_fitting_test/enformer_dsqtls_interpret_small_ld_indi/
#mkdir $output_dirn
