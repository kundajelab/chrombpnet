...
do
    CUDA_VISIBLE_DEVICES=0 kerasAC_bpnet_shap_wrapper \
			--model_hdf5 /srv/scratch/annashch/chrombpnet/gm12878_dnase/with_bias_bpnet_tobias/gm12878.dnase.with.bpnet.tobias.bias.$fold.hdf5 \
			--ref_fasta /mnt/data/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta \
			--bed_regions GM12878.dnase.idr.optimal_peak.narrowPeak.gz \
			...
			--out_pickle GM12878.DNASE.bias_corrected_bpnet_tobias.fold$fold.deepSHAP \
			--num_threads 10
done
