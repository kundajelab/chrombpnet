import pandas as pd
import pdb 
data=pd.read_csv("idr.optimal_peak.narrowPeak.gz",header=None,sep='\t')
...
data_final.to_csv("GM12878.idr.peaks.50bp.around.summit.bed",sep='\t',header=False,index=False) 
