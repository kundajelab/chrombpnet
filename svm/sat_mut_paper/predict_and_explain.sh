...
do
    ...
    gkmpredict -v 2 -T 16 regions.hepg2.txt $dnase_prefix/HEPG2/models/HEPG2.$fold.model.txt hepg2.dnase.preds.$fold
    #get interpretations
...
do
    #get predictions 
    gkmpredict -v 2 -T 16 regions.k562.txt $dnase_prefix/K562/models/K562.$fold.model.txt k562.dnase.preds.$fold
    #get interpretations
    gkmexplain regions.k562.txt $dnase_prefix/K562/models/K562.$fold.model.txt k562.dnase.gkmexplain.$fold    
done
