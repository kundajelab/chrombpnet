...
#data=pd.read_csv("logs/checkpoint/JAN_02_2023/model_dir_subsample_atac_new.csv",sep=",", names=["fold", "cell", "cell1", "model"])
...
for i,r in data.iterrows():
        ...
        #chrombpnet_nb=r["model"]+"/chrombpnet_wo_bias.h5"
        #chrombpnet=r["model"]+"/chrombpnet.h5"
        cellline=r["cell"]
        outputf="results/chrombpnet/auprc_curves/subsampling/"+cellline+"/"+cellline+"_"+r["fold"].replace("_","")
        #gpu="MIG-166d7783-762d-5f61-b31c-549eb4e0fba0"
        #gpu="MIG-e51a0bcb-591a-51ec-a597-81839fe74711"
        gpu="0"
