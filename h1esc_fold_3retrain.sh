...
cur_file_name="h1esc_fold_3retrain.sh"
### SIGNAL INPUT
fold=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/ENCODE_ATAC_downloads/splits/fold_3.json
bias_h5=/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/chrombpnet/folds/DNASE/H1ESC/H1ESC_07.07.2022_bias_128_4_1234_0.8_fold_3_data_type_DNASE_SE/bias_model/bias.h5
