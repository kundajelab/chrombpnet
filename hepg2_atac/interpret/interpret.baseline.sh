...
CUDA_VISIBLE_DEVICES=1 kerasAC_bpnet_shap_wrapper \
		    --model_hdf5 /srv/scratch/annashch/deeplearning/profile/hepg2_atac/baseline/hepg2.atac.seed.1234.cs.50.filters.500.naive.range.4.6.to.11.5.$fold.hdf5 \
		    ...
		    --out_pickle HEPG2.ATAC.baseline.fold$fold.deepSHAP \
		    --num_threads 10
