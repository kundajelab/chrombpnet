import pandas as pd
import pdb 
data=pd.read_csv("K562.dnase.idr.optimal_peak.narrowPeak.gz",header=None,sep='\t')
...
data_final.to_csv("K562.idr.peaks.50bp.around.summit.bed",sep='\t',header=False,index=False) 
