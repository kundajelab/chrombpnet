...
def getModelGivenModelOptionsAndWeightInits(args):
    ...
    profile_capacity_conv=Conv1D(50,kernel_size=3,padding='valid',activation='relu',name='profile_head_capacity_conv')(combined_conv)
    count_capacity_conv=Conv1D(50,kernel_size=3,padding='valid',activation='relu',name='count_head_capacity_conv')(combined_conv)    
    profile_out_prebias = Conv1D(filters=num_tasks,kernel_size=profile_kernel_size,padding='valid',name='profile_out_prebias')(profile_capacity_conv)
