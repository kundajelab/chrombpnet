...
do
    ./train.bpnet.tobias.sh $fold 3 bpnet.tobias.bias.preds.k562 1234 /srv/scratch/annashch/chrombpnet/k562_dnase/bpnet/pred_from_bias params.bpnet.tobias.$fold.txt
done
