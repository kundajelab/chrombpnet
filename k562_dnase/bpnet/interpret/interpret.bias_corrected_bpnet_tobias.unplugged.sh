...
CUDA_VISIBLE_DEVICES=3 kerasAC_bpnet_shap_wrapper \
		    --model_hdf5 /srv/scratch/annashch/deeplearning/profile/k562_dnase/bpnet/with_bias_unplugged/k562.dnase.with.bias.unplugged.$fold.hdf5 \
		    ...
		    --out_pickle K562.DNASE.bias_corrected_bpnet_tobias.unplugged.fold$fold.deepSHAP \
		    --num_threads 10
