...
CUDA_VISIBLE_DEVICES=0 kerasAC_predict \
		    --batch_size 20 \
		    ...
		    --predictions_hdf5 predictions.summits.microglia.0.chr1
...
CUDA_VISIBLE_DEVICES=0 kerasAC_predict \
		    ...
		    --predictions_hdf5 predictions.summits.microglia.0.chr1.trainedonpeaks
