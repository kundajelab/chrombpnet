import pandas as pd
import pdb 
data=pd.read_csv("IMR90.dnase.idr.optimal_peak.narrowPeak.gz",header=None,sep='\t')
...
data_final.to_csv("IMR90.idr.peaks.50bp.around.summit.bed",sep='\t',header=False,index=False) 
