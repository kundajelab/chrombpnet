fold=0
CUDA_VISIBLE_DEVICES=1 python profile_deepshap_for_shuffled_seq.py \
		    --model_hdf5 imr90.dnase.with.bias.unplugged.0.hdf5 \
		    --ref_fasta /mnt/data/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta \
		    --bed_regions IMR90.1k.dnase.idr.optimal_peak.narrowPeak \
		    ...
		    --out_pickle IMR90.DNASE.bias_corrected_bpnet_tobias.unplugged.SHUFFLED.fold$fold.deepSHAP \
		    --num_threads 20 \
		    --num_inputs 1 \
		    --num_outputs 2 \
		    --task_index 0
