...
CUDA_VISIBLE_DEVICES=$gpu kerasAC_train \
		    ...
		    --tdb_partition_datasets_for_upsample ENCSR000EMU \
		    ...
		    --tdb_input_min None \
		    --tdb_input_max None \
		    --tdb_output_min None 4 \
		    --tdb_output_max None 10.5 \
		    --num_inputs 1 \
		    --num_outputs 2 \
		    --tdb_input_datasets seq \
		    --tdb_output_datasets ENCSR000EMU ENCSR000EMU \
		    --fold $fold \
		    --genome hg38 \
		    --num_train 10000 \
		    --num_valid 1000 \
		    ...
		    --architecture_from_file signal_from_tobias_and_bpnet.py \
		    --model_params $params \
