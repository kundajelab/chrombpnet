...
CUDA_VISIBLE_DEVICES=$GPU step7_interpret_chrombpnet_model.sh $reference_fasta $output_data/subsample_peaks/30K.subsample.overlap.bed $output_models/chrombpnet_model/chrombpnet_nobias.h5 $output_models/chrombpnet_model/interpret/
