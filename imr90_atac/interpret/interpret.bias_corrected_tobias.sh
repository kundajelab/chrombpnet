...
CUDA_VISIBLE_DEVICES=1 kerasAC_bpnet_shap_wrapper \
		    --model_hdf5 /srv/scratch/annashch/chrombpnet/imr90_atac/with_bias_tobias/imr90.atac.with.tobias.bias.$fold.hdf5 \
		    --ref_fasta /mnt/data/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta \
		    --bed_regions IMR90.atac.idr.optimal_peak.narrowPeak.gz \
		    ...
		    --out_pickle IMR90.ATAC.bias_corrected_tobias.fold$fold.deepSHAP \
		    --num_threads 10
done
