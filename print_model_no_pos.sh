...
# with_print_bias_train.py
echo $( timestamp ): "python $PWD/src/training/with_print_bias_train.py \\
       --genome=$reference_fasta \\
       --bigwig=$bigwig_path \\
       --bias_bigwig=$bias_bigwig \\
       --peaks=$output_dir/filtered.peaks.bed  \\
       --params=$output_dir/chrombpnet_model_params.tsv \\
       --output_prefix=$output_dir/print \\
       --chr_fold_path=$fold \\
       --batch_size=64 \\
       --architecture_from_file=$PWD/src/training/models/chrombpnet_with_print_bias_bigwig.py \\
...
python $PWD/src/training/with_print_bias_train.py \
       --genome=$reference_fasta \
       --bigwig=$bigwig_path \
       --bias_bigwig=$bias_bigwig \
       --peaks=$output_dir/filtered.peaks.bed  \
...
#chrombpnet_with_print_bias_bigwig.py
...
≈echo $( timestamp ): "python $PWD/src/training/predict.py \\
        ...
        --output_prefix=$output_dir/print \\
        --batch_size=256 \\
        --model_h5=$output_dir/print_wo_bias.h5" | tee -a $logfile
