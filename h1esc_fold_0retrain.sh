...
cur_file_name="h1esc_fold_0retrain.sh"
### SIGNAL INPUT
fold=/oak/stanford/groups/akundaje/projects/chrombpnet/model_inputs/ENCODE_ATAC_downloads/splits/fold_0.json
bias_h5=/mnt/lab_data2/anusri/chrombpnet/results/chrombpnet/DNASE_SE/H1ESC/nautilus_runs_apr12/H1ESC_04.09.2022_bias_128_4_1234_0.8_fold_0/bias_model/bias.h5
