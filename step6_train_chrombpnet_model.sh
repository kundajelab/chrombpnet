...
echo $( timestamp ): "python $codedir/src/helpers/hyperparameters/find_chrombpnet_hyperparams.py \\
...
python $codedir/src/helpers/hyperparameters/find_chrombpnet_hyperparams.py \
       --genome=$reference_fasta \
       --bigwig=$bigwig_path \
       --peaks=$overlap_peak \
       --nonpeaks=$nonpeaks \
...
if [[ "$data_type" = "DNASE_SE" || "$data_type" = "DNASE_PE" ]] ; then
        ...
        echo $( timestamp ): "python $codedir/src/evaluation/marginal_footprints/marginal_footprinting.py \\
        -g $reference_fasta \\
        ...
        python $codedir/src/evaluation/marginal_footprints/marginal_footprinting.py \
        -g $reference_fasta \
        -r $output_dir/filtered.nonpeaks.bed \
        -chr "chr1" \
        -m $output_dir/chrombpnet_wo_bias.h5 \
