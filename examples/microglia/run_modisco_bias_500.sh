#prefix=/srv/scratch/annashch/chrombpnet/microglia/results/chrombpnet/ATAC/microglia/4_4_shifted_ATAC_10.11.2021_bias_filters_500/invivo_bias_model_step1
prefix=/data/chrombpnet/microglia/results/chrombpnet/ATAC/microglia/4_4_shifted_ATAC_10.11.2021_bias_filters_500/invivo_bias_model_step1
#CUDA_VISIBLE_DEVICES=0 kerasAC_form_modisco_inputs --model_hdf5 $prefix/microglia.0.hdf5 \
