...
if [[ -d $output_dir/final_model_step3 ]] ; then
    ...
    cp $PWD/naked_dna_scripts/$cur_file_name $output_dir/final_model_step3
fi
...
if [[ -d $output_dir/final_model_step3/unplug ]] ; then
    ...
    cp $PWD/naked_dna_scripts/$cur_file_name $output_dir/final_model_step3/unplug
fi
...
if [[ -d $output_dir/final_model_step3/unplug/deepshap ]] ; then
    ...
    cp $PWD/naked_dna_scripts/$cur_file_name $output_dir/final_model_step3/unplug/deepshap
...
then
    if [[ -d $output_dir/invivo_bias_model_step1/deepshap ]] ; then
        ...
        cp $PWD/naked_dna_scripts/$cur_file_name $output_dir/invivo_bias_model_step1/deepshap
    fi
else
