...
overlap_peak=/oak/stanford/groups/akundaje/projects/atlas/dnase_processed/dnase/13da5ebe-0941-4855-8599-40bbcc5c58b4/call-reproducibility_overlap/execution/optimal_peak.narrowPeak
#.gz file?
...
data_dir=$PWD/$cell_line/$data_type"_data"
naked_data_dir=$PWD/naked_dna_scripts/$data_type"_data"
...
if [[ -d $naked_data_dir ]] ; then
    ...
    ./main_scripts/preprocess.sh $naked_bam $naked_data_dir $samtools_flag $is_filtered $data_type $neg_shift $chrom_sizes
