...
def fetch_pred_tar(encid, args_json, model_paths, name):
	...
	bedn = pd.read_csv("/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/chrombpnet/folds/ATAC/"+name+"/preds_upload/fold_0/"+name+"_wo_bias_all_regions.bed", sep='\t', header=None)
